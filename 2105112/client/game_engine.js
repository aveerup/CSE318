...
const AI_move = (score_heuristic) => {
    ...
    let val = min_max(new_board, 3, -Infinity, +Infinity, true, bst_move, score_heuristic);
    console.log(bst_move);
